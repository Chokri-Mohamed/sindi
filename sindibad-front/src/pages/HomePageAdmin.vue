...
<q-toolbar-title>
  ...
  Sindibad
      ...
      <q-btn flat label="Adverts" href="/myads/2" />

      <q-btn flat label="Users" href="/users" />
...
<!-- Three vertical cards -->
  ...
  <hr>
<div class="card-container">
    <div v-for="(group, index) in groupedAdverts_1" :key="index" class="card-group">
      <q-card v-for="advert in group" :key="advert.title" class="card">
        <q-card-section>
          <h4>{{ advert.title }}</h4>
          <img class="imgg" :src="imgs[advert.id]" alt="">
...
// const api = 'https://61b0-102-152-214-192.ngrok.io/individual/adverts?pageSize=3&pageNum='
